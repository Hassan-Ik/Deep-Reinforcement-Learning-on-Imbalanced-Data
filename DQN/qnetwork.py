...
class QNetwork:
    def __init__(self, state_size, action_size, learning_rate: float, image:bool = True, network_type: str = 'ddqn'):
        ...
        # If we are going to use Double Deep Q Network
    ...
    def build_network(self, image=True):
        ...
        if image == True:
            ...
            # Convolution Layers
            conv2 = tf.keras.layers.Conv2D(32, (5, 5), strides=2, activation=tf.nn.relu)(input_layer)
            conv2 = tf.keras.layers.Conv2D(64, (3,3), strides=2, activation=tf.nn.relu)(conv2)
